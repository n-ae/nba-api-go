...
func TestGetBoxScoreFourFactorsV2_Generated(t *testing.T) {
	...
	const wantPath = "/boxscorefourfactorsv2"
	var gotPath string
	...
	if gotPath != wantPath {
		t.Errorf("GetBoxScoreFourFactorsV2 requested path %q, want %q (endpoint metadata says %q)", gotPath, wantPath, "boxscorefourfactorsv2")
	}
