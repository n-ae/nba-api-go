...
// TeamDashboardByClutchRequest contains parameters for the TeamDashboardByClutch endpoint
type TeamDashboardByClutchRequest struct {
	TeamID      string
	MeasureType *string
...
// TeamDashboardByClutchOverallTeamDashboard represents the OverallTeamDashboard result set for TeamDashboardByClutch
type TeamDashboardByClutchOverallTeamDashboard struct {
...
// TeamDashboardByClutchLast5MinCloseGame5PointTeamDashboard represents the Last5MinCloseGame5PointTeamDashboard result set for TeamDashboardByClutch
type TeamDashboardByClutchLast5MinCloseGame5PointTeamDashboard struct {
	TEAM_ID     int     `json:"TEAM_ID"`
	TEAM_NAME   string  `json:"TEAM_NAME"`
...
// TeamDashboardByClutchResponse contains the response data from the TeamDashboardByClutch endpoint
type TeamDashboardByClutchResponse struct {
	OverallTeamDashboard                 []TeamDashboardByClutchOverallTeamDashboard
	Last5MinCloseGame5PointTeamDashboard []TeamDashboardByClutchLast5MinCloseGame5PointTeamDashboard
}

// GetTeamDashboardByClutch retrieves data from the teamdashboardbyclutch endpoint
	...
	if len(rawResp.ResultSets) > 1 {
		...
		for _, row := range rawResp.ResultSets[1].RowSet {
			if len(row) >= 29 {
				...
				response.Last5MinCloseGame5PointTeamDashboard = append(response.Last5MinCloseGame5PointTeamDashboard, item)
			}
		}
	}
