...
func TestGetPlayerCareerByCollege_Generated(t *testing.T) {
	...
	const wantPath = "/playercareerbycollege"
	var gotPath string
	...
	if gotPath != wantPath {
		t.Errorf("GetPlayerCareerByCollege requested path %q, want %q (endpoint metadata says %q)", gotPath, wantPath, "playercareerbycollege")
	}
