...
// TestGetLeagueDashPtDefend_Generated is generated from tools/generator/metadata;
...
func TestGetLeagueDashPtDefend_Generated(t *testing.T) {
	...
	if len(resp.Data.LeagueDashPtDefend) == 0 {
		t.Errorf("expected LeagueDashPtDefend to be populated from the synthesized fixture, got empty")
	}
}
