...
func TestGetLeagueDashPlayerShotLocationV2_Generated(t *testing.T) {
	...
	const wantPath = "/leaguedashplayershotlocationv2"
	var gotPath string
	...
	if gotPath != wantPath {
		t.Errorf("GetLeagueDashPlayerShotLocationV2 requested path %q, want %q (endpoint metadata says %q)", gotPath, wantPath, "leaguedashplayershotlocationv2")
	}
