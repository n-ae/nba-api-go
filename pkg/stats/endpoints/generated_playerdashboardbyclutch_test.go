...
// TestGetPlayerDashboardByClutch_Generated is generated from tools/generator/metadata;
...
func TestGetPlayerDashboardByClutch_Generated(t *testing.T) {
	...
	req := PlayerDashboardByClutchRequest{
		PlayerID: "1",
	}
	...
	if len(resp.Data.Last5MinCloseGame5PointPlayerDashboard) == 0 {
		t.Errorf("expected Last5MinCloseGame5PointPlayerDashboard to be populated from the synthesized fixture, got empty")
	}
}
