...
- **[Current Maintainability Assessment](./MAINTAINABLE_ARCHITECT_V4_ASSESSMENT.md)** - Project maintainability analysis of record (stable path - see the file's own naming-convention note for why this link never needs updating again)
