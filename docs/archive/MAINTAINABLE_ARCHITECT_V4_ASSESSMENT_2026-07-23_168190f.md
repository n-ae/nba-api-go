> **Superseded.** This is the archived content of `docs/MAINTAINABLE_ARCHITECT_V4_ASSESSMENT.md` as of revision `168190f` (tag `v3.1.15`), 2026-07-23. It has been replaced by a newer assessment cycle (revision `4ab1ce1`, tag `v3.1.16`) at that same stable path. Kept here for historical reference only - do not treat anything below as current.
