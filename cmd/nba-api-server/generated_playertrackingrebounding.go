...
// handlePlayerTrackingRebounding is generated from tools/generator/metadata; see
// tools/generator/templates/handler.tmpl. Do not hand-edit - regenerate via
// `cd tools/generator && go run . -endpoint PlayerTrackingRebounding` (or -all-handlers to
