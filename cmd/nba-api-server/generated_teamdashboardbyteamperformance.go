...
// handleTeamDashboardByTeamPerformance is generated from tools/generator/metadata; see
// tools/generator/templates/handler.tmpl. Do not hand-edit - regenerate via
// `cd tools/generator && go run . -endpoint TeamDashboardByTeamPerformance` (or -all-handlers to
