...
// handlePlayerCompare is generated from tools/generator/metadata; see
// tools/generator/templates/handler.tmpl. Do not hand-edit - regenerate via
// `cd tools/generator && go run . -endpoint PlayerCompare` (or -all-handlers to
// regenerate every handler plus the dispatch table) instead.
func (h *StatsHandler) handlePlayerCompare(w http.ResponseWriter, r *http.Request) {
	vPlayerIDList := r.URL.Query().Get("PlayerIDList")
	if vPlayerIDList == "" {
